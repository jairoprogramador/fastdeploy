...
func NewResolverService() services.ResolverService {
	return &Resolver{}
}

func (r *Resolver) ResolveString(template string, variables map[string]vos.Output) (string, error) {
	var firstErr error
...
func (r *Resolver) ResolvePath(path string, variables map[string]vos.Output) error {
...
func (r *Resolver) resolverTemplateFile(filePath string, variables map[string]vos.Output) error {
	...
	interpolatedContent, err := r.ResolveString(string(content), variables)
	if err != nil {
...
func (r *Resolver) ResolveOutput(output vos.Output, record string) (vos.Output, bool, error) {
