...
func (git *localGitRequest) GetHash(ctx context.Context) model.InfraResultEntity {
	return git.executeCommand(ctx, cmdGetHash)
}

func (git *localGitRequest) GetAuthor(ctx context.Context, commitHash string) model.InfraResultEntity {
...
func (git *localGitRequest) GetMessage(ctx context.Context, commitHash string) model.InfraResultEntity {
	if err := validateCommitHash(commitHash); err != nil {
		return git.logError(err)
	}
...
func (git *localGitRequest) executeCommand(ctx context.Context, command string) model.InfraResultEntity {
...
func (git *localGitRequest) logError(err error) model.InfraResultEntity {
	if err != nil {
