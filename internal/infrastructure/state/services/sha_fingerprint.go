...
func (s *ShaFingerprintService) GenerateFromPath(pathProject string) (staVos.Fingerprint, error) {
...
func (s *ShaFingerprintService) GenerateFromStepDefinition(pathTemplate string, runParams appDto.RunParams) (staVos.Fingerprint, error) {
...
func (s *ShaFingerprintService) GenerateFromVariables(vars map[string]string) (staVos.Fingerprint, error) {
...
func (s *ShaFingerprintService) getStepsPathToIgnore(pathTemplate, stepName string) ([]string, error) {
...
func (s *ShaFingerprintService) getVarsPathToIgnore(pathTemplate, stepName, environment string) ([]string, error) {
...
func (s *ShaFingerprintService) getVariablesStepFileToIgnore(pathTemplate, stepName, environment string) ([]string, error) {
...
func (s *ShaFingerprintService) generateHash(
	pathSource string,
...
func (s *ShaFingerprintService) generateHashFromSource(pathSource string, ignorer *gitignore.GitIgnore) (staVos.Fingerprint, error) {
...
func (s *ShaFingerprintService) hashFile(filePath string) (string, error) {
...
func (s *ShaFingerprintService) generateHashStringForMap(data map[string]string) (string, error) {
	if len(data) == 0 {
