...
func (r *YamlConfigRepository) Save(config *proAgg.MyProject, pathProject string) error {
...
func (r *YamlConfigRepository) Load(pathProject string) (*proAgg.MyProject, error) {
	pathFileConfig := r.PathFileConfig(pathProject)
