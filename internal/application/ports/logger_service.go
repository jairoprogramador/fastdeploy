...
type LoggerService interface {
	ShowError(stepName string, err error) error
	ShowLog(pathProject string) error
	StartLog(namesParams appDto.NamesParams, contextData map[string]string, revision string) (*aggregates.Logger, error)
