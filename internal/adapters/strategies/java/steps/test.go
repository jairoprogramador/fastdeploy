...
func NewJavaTest(repositoryPath string, executor executor.ExecutorCmd) steps.TestStrategy {
	return &JavaTest{repositoryPath: repositoryPath, executor: executor}
}

func (s *JavaTest) ExecuteTest(ctx context.Context) error {
