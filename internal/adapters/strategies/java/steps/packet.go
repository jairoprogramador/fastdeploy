...
func NewJavaPacket(repositoryPath string, executor executor.ExecutorCmd) steps.PacketStrategy {
	return &JavaPacket{repositoryPath: repositoryPath, executor: executor}
}

func (s *JavaPacket) ExecutePacket(ctx context.Context) error {
